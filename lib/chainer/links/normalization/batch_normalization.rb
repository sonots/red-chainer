  ...
  module Links
    module Normalization 
      class BatchNormalization < Chainer::Link
        ...
        # @param [Cumo::NArray.dtype] dtype Type to use in computing.
        ...
        def initialize(size, decay: 0.9, eps: 2e-5, dtype: Cumo::SFloat, use_gamma: true, use_beta: true, initial_gamma: nil, initial_beta: nil)
          super()
