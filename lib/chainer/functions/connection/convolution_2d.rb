  ...
  module Functions
    module Connection
      class Convolution2DFunction < Chainer::Function
        ...
        #
        # @param [Chainer::Variable or Cumo::NArray] x Input variable of shape :math:`(n, c_I, h_I, w_I)`.
        # @param [Chainer::Variable or Cumo::NArray] w Weight variable of shape :math:`(c_O, c_I, h_K, w_K)`.
        # @param [Chainer::Variable or Cumo::NArray] b Bias variable of length :math:`c_O`
